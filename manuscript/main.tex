...
associados a cores. No entanto, a seleção dos vértices é feita de maneira mais
cautelosa, usando como critério a quantidade de arestas para conjuntos de vértices
ainda sem coloração~\cite{Pa08}.
